...
class PeopleQuery < Query
  ...
  def initialize_available_filters
    ...
    :values => [
     ...
     ], :order => 15, :name => l(:label_people_is_system)
    ...
    add_available_filter "tags", :type => :list, :values => Person.available_tags.collect{ |t| [t.name, t.name] }, :order => 18, :name => l(:label_people_tags_plural)
